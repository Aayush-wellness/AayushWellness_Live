          ...
          <div className="pt-8 px-4">
            ...
            <div className="max-w-screen-lg mx-auto">
              <div className="space-y-8">
                <section>
                  <h3 className="text-2xl font-bold mb-4" style={{letterSpacing:"1.5px"}} > Aayush Wellness Mission </h3>
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4"style={{letterSpacing:"1.5px"}} >Combatting Tobacco Addiction</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
                    <li>
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4" style={{letterSpacing:"1.5px"}}>Nutritional Supplementation for All</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4" style={{letterSpacing:"1.5px"}}>Enhancing Healthcare Accessibility</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4" style={{letterSpacing:"1.5px"}}>Holistic Approach</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
                ...
                <section> 
                  <h3 className="text-2xl font-bold mb-4"style={{letterSpacing:"1.5px"}}>Aayush Wellness Vision</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4"style={{letterSpacing:"1.5px"}}>Holistic Health Approach</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
                    <li>
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4"style={{letterSpacing:"1.5px"}} >Integrating Ayurveda with Modern Medicine</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4" style={{letterSpacing:"1.5px"}}>Personalized Wellness Plans</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4"style={{letterSpacing:"1.5px"}}>Emphasis on Prevention and Sustainability</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
                    <li>
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4"style={{letterSpacing:"1.5px"}}>Community and Global Impact</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
                ...
                <section>
                  <h3 className="text-2xl font-bold mb-4"style={{letterSpacing:"1.5px"}}>Innovation and Continuous Learning</h3>
                  <ul className="list-disc list-inside space-y-4 text-lg">
