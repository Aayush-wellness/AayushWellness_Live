...
const NewFooter = () => {
  ...
  const [videoSrc, setVideoSrc] = useState("https://res.cloudinary.com/dcs4uo7ub/video/upload/v1754118999/rnmwqvamasqxg9jgh7y3_qeqcbs.m3u8")
  const videoRef = useRef(null)

  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth <= 768) {
        setVideoSrc("https://res.cloudinary.com/dcs4uo7ub/video/upload/v1754118993/zyrxramkyunlff9ffpxd_bhvoig.m3u8")
      } else {
        setVideoSrc("https://res.cloudinary.com/dcs4uo7ub/video/upload/v1754118999/rnmwqvamasqxg9jgh7y3_qeqcbs.m3u8")
      }
    }
